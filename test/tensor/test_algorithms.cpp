...
BOOST_FIXTURE_TEST_CASE_TEMPLATE( test_tensor_algorithms_copy, value,  test_types2, fixture )
{
    ...
    for(auto const& n : extents) {
        ...
        auto wa = ublas::strides_t<ublas::extents<>,ublas::first_order>(n);
        auto wb = ublas::strides_t<ublas::extents<>,ublas::last_order> (n);
        auto wc = ublas::strides_t<ublas::extents<>,ublas::first_order>(n);
        ...
        using size_type = typename ublas::strides_t<ublas::extents<>,ublas::first_order>::value_type;
